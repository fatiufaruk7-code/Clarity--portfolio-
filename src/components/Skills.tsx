      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {filteredSkills.map((skill, index) => (
            ...
            >
              <div
                className="p-5 rounded-2xl bg-[#111827] border border-[#1E293B] hover:border-[#8B5CF6]/50 transition-all duration-300 hover:bg-[#151D30] hover:-translate-y-1 group h-full flex flex-col justify-between"
                id={`skill-${skill.id}`}
              >
                <div>
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-[#0E1428] border border-[#1E293B] flex items-center justify-center group-hover:scale-108 transition-transform duration-300">
                ...
                {/* Progress bar */}
                <div className="w-full h-1.5 bg-[#0E1428] rounded-full overflow-hidden border border-white/5 mt-auto">
                  <div
                    className="h-full bg-gradient-to-r from-[#8B5CF6] to-[#3B82F6] rounded-full transition-all duration-700 ease-out"
